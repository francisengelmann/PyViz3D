...
def main():
    ...
    v.add_superquadric('sq_3', exponents=np.array([0.1, 2.0, 140.0]), scalings=np.array([1.0, 1.0, 1.0]), color=np.array([0.0, 100.0, 255.0]), translation=np.array([3.0, 2.0, 1.0]), resolution=100)
